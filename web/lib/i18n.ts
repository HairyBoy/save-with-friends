...
const en = {
  ...
  create: {
    ...
    typeSolo: "Just me",
    typeShared: "Shared",
    earnLabel: "Savings Mode",
    earnStandard: "Standard",
    earnYield: "Earn Interest",
    earnHintStandard: "Your money stays locked until you reach your goal.",
    earnHintEarn: "Your money earns interest while it's locked — you keep all of it.",
    earnUnavailable: "Earning interest is available on mainnet.",
...
const es: typeof en = {
  ...
  create: {
    ...
    earnLabel: "Modo de ahorro",
    earnStandard: "Normal",
    earnYield: "Gana intereses",
    earnHintStandard: "Tu plata queda guardada hasta que alcances tu meta.",
    earnHintEarn: "Tu plata gana intereses mientras está guardada — todo es para ti.",
    earnUnavailable: "Ganar intereses está disponible en mainnet.",
