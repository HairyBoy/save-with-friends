...
const en = {
  ...
  vaultDetail: {
    ...
    earlyExitSoon:
      "Early exit needs your friends to hold on-chain keys — that arrives with shared vaults.",
...
const es: typeof en = {
  ...
  vaultDetail: {
    ...
    earlyExitSoon:
      "La apertura anticipada necesita que tus amigos tengan llaves on-chain — llega con las alcancías compartidas.",
